...
public class Board : MonoBehaviour
{
    ...
    [Header("Tiles")]
    [SerializeField]
    private GameObject folderTiles = null;
    [SerializeField]
    ...
    {
        if (GameManager.Paused || GameManager.GameIsOver || shiftDownTilesCoroutine != null)
            return;
    ...
    {
        folderTiles.SetActive(false);
    }

    public void EnableBoard()
    {
        folderTiles.SetActive(true);
    }
